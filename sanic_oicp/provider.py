...
if TYPE_CHECKING:
    from sanic_oicp import UserManager
...
class Provider(object):
    def __init__(self,
        ...
        self.users: UserManager = user_manager_class()
        self.clients: ClientStore = client_manager_class()
        self.codes: CodeStore = code_manager_class()
        self.tokens: TokenStore = token_manager_class()
